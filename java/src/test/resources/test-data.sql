...
INSERT INTO campaign (campaign_name, description, funding_goal, start_date, end_date, locked, public) -- id 3
VALUES ('Doomed to Fail', 'Why do I even try', 100, '2024-1-3', '2024-1-23', true, false);

INSERT INTO campaign_manager VALUES (1, 1, true);
INSERT INTO campaign_manager VALUES (2, 2, true);
INSERT INTO campaign_manager VALUES (3, 3, true);
INSERT INTO campaign_manager VALUES (4, 1, true);
